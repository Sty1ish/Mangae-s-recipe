...
class RecipeOrder(models.Model):
    recipe = models.ForeignKey(Recipe, related_name='recipe orders', on_delete=models.CASCADE)
...
class RecipeLink(models.Model):
    recipe = models.ForeignKey(Recipe, related_name='recipe link', on_delete=models.CASCADE)
